...
static_assert(std::is_same_v<
              PromotedType<Vecteur<float, 3>, Vecteur<int, std::dynamic_extent>>::type, float>);
static_assert(
    PromotedType<Vecteur<float, 3>, Vecteur<int, std::dynamic_extent>>::size == std::dynamic_extent
);
